...
public class int32Data extends DataStructure<Integer> {
	...
	public int32Data(String name, int id) {
		super(name, id, format, compatibleFormats);
	}

	public int32Data(String name, int id, Dictionary<String, String> settings) {
	...
	protected Integer[] valueOf(String... input) throws IllegalDataFormatException {
		...
		for(int i = 0; i < input.length; i++) {
			try {
				...
				throw new IllegalDataFormatException("'" + input[i] + "' is not a valid 32-bit integer!", i);
			}
		}
